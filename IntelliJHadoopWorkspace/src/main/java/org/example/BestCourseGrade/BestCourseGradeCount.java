 ...
 *
 */
public class BestCourseGradeCount {
    public static void main(String[] args) throws Exception
    {
        ...
        wcJob.setJarByClass(BestCourseGradeCount.class);
        wcJob.setMapperClass(BestCourseGradeMapper.class);
        wcJob.setCombinerClass(BestCourseGradeReducer.class);
        wcJob.setReducerClass(BestCourseGradeReducer.class);
