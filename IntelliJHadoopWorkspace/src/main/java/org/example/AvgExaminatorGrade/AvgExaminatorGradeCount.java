 ...
 *
 */
public class AvgExaminatorGradeCount {
    public static void main(String[] args) throws Exception
    {
        ...
        wcJob.setJarByClass(AvgExaminatorGradeCount.class);
        wcJob.setMapperClass(AvgExaminatorGradeMapper.class);
        wcJob.setCombinerClass(AvgExaminatorGradeReducer.class);
        wcJob.setReducerClass(AvgExaminatorGradeReducer.class);
